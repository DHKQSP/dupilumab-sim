...
lloq_impact <- sprintf("Simulated at 0.02 to 0.5 mg/L with the same subjects (Section 5.10): window coverage of AUC0-last below 80%% in %s%% of subjects; reliability under criteria (i) %s%% (0.02 mg/L) to %s%% (0.5 mg/L); boundary type I error of AUC0-last + Cmax %s%% (M0) and %s%% (M1) in three boundary scenarios.",

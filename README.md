...
scripts/                      run_tests.R, 02_validate_step1.R, 02b_step1_diagnostics.R, 10–13 시뮬레이션, 05_report.R, run_all.sh
...
```
- 개별 실행: `Rscript scripts/run_tests.R`, `scripts/02_validate_step1.R`, `02b_step1_diagnostics.R`, `10_individual_schedules.R [변형...]`, `11_trial_schedules.R [변형] [시험 수] [코어]`, `12_trial_products.R [시험 수] [코어]`, `13_crossval.R [시험 수] [코어]`, `05_report.R`.
